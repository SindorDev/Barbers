...
import ProfileModals from '../../components/profile-modal/ProfileModals';
...
const Profile = () => {
    ...
    <div className='w-full min-h-screen bg-[#f3f3f3] flex items-center justify-center'>
      ...
      <div className='w-full p-5'>
        ...
        >
          ...
          <Button onClick={() => handleUpdate(data?.payload)} type='primary' className='!bg-yellow-500 text-[20px] py-5'><BiEdit size={24} /> </Button>
          </div>
  ...
  />
      ...
      <ProfileModals open={open} data={update} setUpdate={setUpdate} setOpen={setOpen}/>
    </>
  );
};
